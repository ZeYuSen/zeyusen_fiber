...
export const es: PagesContent = {
  about: {
    ...
    lead: "es un fabricante de Nantong, provincia de Jiangsu, China, centrado en mantas de fibra de carbono, mantas y velos de fibra de vidrio, y papel para rotores desecantes.",
    story1:
    ...
    story2: {
      pre: "Nuestra cartera se concentra en ",
      carbonLink: "mantas de fibra de carbono",
      mid: ", ",
      glassLink: "mantas y velos de fibra de vidrio",
      post: " y papel para rotores desecantes. Estos materiales se destinan a superficies de composites, nueva energía, materiales de construcción y deshumidificación industrial. El gramaje, ancho, ligante y conversión se confirman para cada proyecto.",
    },
    story3: {
      pre: "Con el 10% del personal dedicado a I+D y dos centros de investigación, empleamos procesos de vía húmeda y vía seca para ofrecer ",
      servicesLink: "selección de materiales, muestras y desarrollo de especificaciones",
      post: " en las tres líneas de producto.",
    },
    quickStats: [
      { num: "10+", label: "Años de Experiencia" },
      { num: "80%+", label: "Recompra de Clientes" },
      { num: "3", label: "Líneas Enfocadas" },
    ...
    values: [
      ...
      { title: "Fabricación Enfocada", description: "Procesos de vía húmeda y vía seca en dos bases para mantas de carbono, mantas de vidrio y papel para rotores." },
