...
export const ko: PagesContent = {
  about: {
    ...
    lead: "는 중국 장쑤성 난퉁에 본사를 두고 탄소섬유 매트, 유리섬유 매트와 베일, 제습 로터 성형지에 집중하는 소재 제조기업입니다.",
    story1:
    ...
    story2: {
      ...
      carbonLink: "탄소섬유 매트",
      mid: ", ",
      glassLink: "유리섬유 매트와 베일",
      post: ", 제습 로터 성형지입니다. 복합재 표면, 신에너지, 건축 자재와 산업용 제습 분야를 지원하며 평량, 폭, 바인더와 후가공 조건은 프로젝트별로 확인합니다.",
    },
    story3: {
      pre: "전체 인력의 10%가 R&D에 전념하고 두 개의 연구 센터를 운영하며, 습식 및 건식 공정을 기반으로 ",
      servicesLink: "소재 선택, 샘플링 및 사양 개발 서비스",
      post: "를 제공합니다.",
    },
    quickStats: [
      { num: "10+", label: "년 경력" },
      { num: "80%+", label: "재구매율" },
      { num: "3", label: "집중 제품 라인" },
      { num: "100%", label: "맞춤 지원" },
    ],
    values: [
      ...
      { title: "집중 생산", description: "두 생산 거점의 습식 및 건식 공정으로 탄소 매트, 유리섬유 매트와 로터 성형지를 생산합니다." },
