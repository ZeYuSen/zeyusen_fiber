...
export const zh: PagesContent = {
  about: {
    eyebrow: "关于我们",
    title: "2015年起专注复合材料",
    lead: "是一家位于中国江苏南通的材料制造企业，聚焦碳毡、玻纤毡和除湿转轮成型纸的研发、生产与销售。",
    story1:
    ...
    story2: {
      ...
      mid: "、",
      glassLink: "玻纤毡",
      post: "和除湿转轮成型纸，服务于复合材料表面、新能源、建筑材料和工业除湿等应用。克重、幅宽、粘结剂和后加工要求按具体项目确认。",
    },
    story3: {
      pre: "10%的员工专注于研发，拥有两个研究中心，通过湿法和干法工艺提供",
      servicesLink: "选材、打样与规格开发服务",
      post: "，支持三条聚焦产品线。",
    },
    quickStats: [
      { num: "10+", label: "年经验" },
    ...
    values: [
      ...
      { title: "聚焦制造", description: "双生产基地采用湿法和干法工艺，生产碳毡、玻纤毡和除湿转轮成型纸。" },
