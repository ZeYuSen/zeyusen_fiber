...
const en: PagesContent = {
  about: {
    ...
    lead: "is a manufacturer based in Nantong, Jiangsu Province, China, focused on carbon fiber mats, fiberglass mats and veils, and desiccant rotor forming paper.",
    story1:
    ...
    story2: {
      pre: "Our focused portfolio brings together ",
      carbonLink: "carbon fiber mats",
      mid: ", ",
      glassLink: "fiberglass mats and veils",
      post: ", and desiccant rotor forming paper. These materials support composite surfaces, new energy, building materials, and industrial dehumidification. Weight, width, binder, and converting requirements are confirmed for each project.",
    },
    story3: {
      pre: "With 10% of our staff dedicated to R&D and two research centers, we use wet-laid and dry-laid processes to support ",
      servicesLink: "material selection, sampling, and specification development",
      post: " for the three focused product lines.",
    },
    quickStats: [
      { num: "10+", label: "Years Experience" },
      { num: "80%+", label: "Repeat Buyers" },
      { num: "3", label: "Focused Product Lines" },
    ...
    values: [
      ...
      { title: "Focused Manufacturing", description: "Wet-laid and dry-laid production across dual bases for carbon mats, fiberglass mats, and rotor forming paper." },
