  ...
  return (
    <section
      className={`relative isolate flex items-end overflow-hidden bg-neutral-950 ${
        compact ? "min-h-[460px] sm:min-h-[520px]" : "min-h-[600px] sm:min-h-[680px] lg:min-h-[760px]"
      }`}
    >
      <Image
        src={image}
      ...
      <div className="container-wide relative z-10 w-full pb-16 pt-32 sm:pb-20 sm:pt-40 lg:pb-24">
        {breadcrumbs ? (
          <div className="mb-8 text-sm text-white/60 [&_a]:transition-colors [&_a:hover]:text-white">
            {breadcrumbs}
          </div>
        ) : null}
        ...
        <div className="max-w-4xl">
          ...
          <h1 className="max-w-[16ch] text-4xl font-semibold leading-[1.05] tracking-tight text-white sm:text-5xl lg:text-6xl xl:text-7xl">
            {title}
          </h1>
          {description ? (
