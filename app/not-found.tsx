...
export const metadata: Metadata = {
  ...
  description:
    "The page you are looking for does not exist. Browse our carbon fiber and glass fiber products or contact us for assistance.",
};

// Root-level 404 (no locale matched). Provides its own <html>/<body> because the
// root layout is a passthrough — html/body normally live in app/[lang]/layout.tsx.
export default function NotFound() {
  return (
    <html lang="en">
      <body className="min-h-screen flex items-center antialiased">
