...
export default async function CarbonProductPage({ params }: Props) {
  ...
  const content = getProductContent("carbon", category.slug, product.slug);
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(breadcrumbJsonLd([
            { name: "Home", href: "/" },
            { name: "Carbon Fiber", href: "/carbon-fiber" },
            { name: category.name, href: `/carbon-fiber/products/${category.slug}` },
            { name: product.name, href: `/carbon-fiber/products/${category.slug}/${product.slug}` },
          ])),
        }}
      />
